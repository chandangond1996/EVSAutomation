package SeliniumPractice.Color;

import org.openqa.selenium.By;
import org.openqa.selenium.chrome.ChromeDriver;
import org.openqa.selenium.support.Color;

public class Practice_Verify_Color {
...
//		BackgroundColor of Delete Button 
		String colorProperties = driver.findElement(By.xpath("//input[@value='Delete']"))
...
//		TextColor of Delete Button Text
		...
		String colorSearchButton = driver.findElement(By.xpath("//input[@value=' Search Now ']"))
				.getCssValue("background-color");
